...
<html class="no-js" lang="en">
   ...
   <!-- Main jumbotron for a primary marketing message or call to action -->
        <section class="main-banner" style="background:#4169E1 url(img/slider-01.jpg) no-repeat">
            <div class="container">
                    ...
                    <form>
                        <fieldset>
                            ...
                            <div class="col-md-2 col-sm-2 no-pad">
                                <button type="submit" class="button is-block is-link is-large is-fullwidth">Submit</button>
                            </div>
                        </fieldset>
                    -->
